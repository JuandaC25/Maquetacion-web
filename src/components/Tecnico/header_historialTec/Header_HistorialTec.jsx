...
function Header_HistorialTec() {
  ...
  const navigateToHome = () => {
    globalThis.location.href = "http://localhost:5173/Login";
  };

  const navigateToBlog = () => {
    globalThis.location.href = "https://electricidadelectronicaytelecomu.blogspot.com/";
  };
  ...
  return (
    <div className='container-xd201tec'> 
          ...
          <div className='icons-container-xd213tec'>
            <div className="buttons-wrapper-xd214tec">
              <div className="button-group-xd215tec">
                <button className="icon-button-xd216tec" onClick={navigateToHome}>
                  <svg
                    className="icon-svg-xd217tec"
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
              ...
              <div className="button-group-xd215tec">
                <button className="icon-button-xd216tec" onClick={navigateToBlog}>
                  <svg
                    className="icon-svg-xd217tec"
                    stroke="currentColor"
                    fill="none"
              ...
              <div className="button-group-xd215tec">
                <button className="icon-button-xd216tec" onClick={handleShowProfile}>
                  <svg
                    className="icon-svg-xd217tec"
                    stroke="currentColor"
                    fill="currentColor"
      ...
      {showProfile && (
        <div className="phone-container-xd219tec">
          <div className="phone-frame-xd220tec">
            <span className="top-border-xd221tec"></span>
            <p className="time-xd222tec">12:00</p>
            <p className="date-xd223tec">Fri, 20 December</p>
            <button className="phone-close-button-xd224tec" onClick={handleCloseProfile}>
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
            ...
            <svg
              className="fingerprint-xd225tec"
              width="26px"
              height="26px"
            ...
            <span className="right-border-top-xd228tec"></span>
            <div className="phone-profile-modal-xd229tec">
              <div className="phone-modal-header-xd230tec">
                <i className="bi bi-person-circle phone-profile-icon-xd231tec"></i>
                <h3 className="phone-profile-title-xd232tec">¡Hola, usuario!</h3>
              </div>
              
              <div className="phone-modal-footer-xd233tec"> 
                <div className="phone-footer-content-xd234tec">
                  <h6>Example@gmail.com</h6>
                  <Button className="phone-profile-button-xd235tec" onClick={handleCloseProfile}>
                    Editar información 
                  </Button>
                </div>
                <div className="phone-footer-content-xd234tec">
                  <Button 
                    className="phone-profile-button-xd235tec" 
