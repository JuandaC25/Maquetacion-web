...
function AdminHeader({ title = "Panel Admin" }) {
    ...
    const handleSaveChanges = async (e) => {
        ...
        try {
            const dataToSend = { nom_us: formData.nom_us, ape_us: formData.ape_us, corre: formData.corre };
            if (formData.password) {
    ...
    const navigateToBlog = () => {
        // External blog - open in new tab without affecting SPA
        window.open('https://electricidadelectronicaytelecomu.blogspot.com/', '_blank', 'noopener');
    };
                ...
                <div className='header-pedidos__content'>
                    ...
                    <Offcanvas show={showMenu} onHide={handleCloseMenu}>
                        ...
                        <Offcanvas.Body className="menu-cards">
                            <Link to="/Admin" className="menu-card" onClick={handleCloseMenu}>
                                <p className="card-title">
                                    <i className="bi bi-ticket-detailed"></i> Estado del ticket
                                </p>
                                <p className="card-subtitle">Ver estado de tickets</p>
                            </Link>
                            <Link to="/Adcrear" className="menu-card" onClick={handleCloseMenu}>
                                <p className="card-title"><i className="bi bi-person-plus"></i> Gestionar usuarios</p>
                                <p className="card-subtitle">Administrar usuarios</p>
                            </Link>
                            <Link to="/Inventario" className="menu-card" onClick={handleCloseMenu}>
                                <p className="card-title"><i className="bi bi-box-seam"></i> Consultar inventario</p>
                                <p className="card-subtitle">Ver elementos disponibles</p>
                            </Link>
                            <Link to="/Solielemento" className="menu-card" onClick={handleCloseMenu}>
                                <p className="card-title"><i className="bi bi-search"></i> Solicitudes de elementos</p>
                                <p className="card-subtitle">Revisar solicitudes</p>
                            </Link>
                            <Link to="/Soliespacio" className="menu-card" onClick={handleCloseMenu}>
                                <p className="card-title"><i className="bi bi-search"></i> Solicitudes espacios</p>
                                <p className="card-subtitle">Revisar reservas</p>
                            </Link>
                            <Link to="/Categorias" className="menu-card" onClick={handleCloseMenu}>
                                <p className="card-title"><i className="bi bi-tags"></i> Gestionar categorías</p>
                                <p className="card-subtitle">Administrar categorías</p>
                            </Link>
                        </Offcanvas.Body>
                    </Offcanvas>
