...
function HeaderAudioVideoPedidos() {
const [showMenu, setShowMenu] = useState(false);
  ...
  return (
    <div className='header-audio-video__container'> 
      <Navbar expand="xxxl" className="w-100">
        <div className='header-audio-video__content'>
          ...
          <h1 className='header-audio-video__title-main'>Solicitud Audio/Video</h1>

          <div className='header-audio-video__icons-container'>
            <div className="header-audio-video__buttons-wrapper">
...
export default HeaderAudioVideoPedidos;
