    ...
    return (
        <div className='header-escritorio__container'>
            <Navbar expand="xxxl" className="w-100">
                <div className='header-escritorio__content'>
                    ...
                    <h1 className='header-escritorio__title-main'>Solicitud Equipos de escritorio</h1>

                    <div className='header-escritorio__icons-container'>
                        <div className="header-escritorio__buttons-wrapper">
