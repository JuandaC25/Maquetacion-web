import { Navbar, Offcanvas, Button, Modal, Form } from 'react-bootstrap';
...
function Headerespacios() {
    ...
    return (
        <div className='header-espacios__container'>
            <Navbar expand="xxxl" className="w-100">
                <div className='header-espacios__content'>
                    ...
                    {/* Título Principal */}
                    <h1 className='header-espacios__title-main'>Solicitud de Espacios</h1>
                    <div className='header-espacios__icons-container'>
                        <div className="header-espacios__buttons-wrapper">
