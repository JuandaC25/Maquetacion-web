...
const [showMenu, setShowMenu] = useState(false);
  ...
  return (
    <div className='header-televisores__container'> 
      <Navbar expand="xxxl" className="w-100">
        <div className='header-televisores__content'>
          ...
          <h1 className='header-televisores__title-main'>Solicitud Televisores</h1>

          <div className='header-televisores__icons-container'>
            <div className="header-televisores__buttons-wrapper">
