...
function Header_ad() {
  ...
  return (
    <div className='header-historial__container'> {/* CAMBIO: header-portatiles__container -> header-historial__container */}
      <Navbar expand="xxxl" className="w-100">
        <div className='header-historial__content'> {/* CAMBIO: header-portatiles__content -> header-historial__content */}
          ...
          <h1 className='header-historial__title-main'>Historial de pedidos</h1> {/* CAMBIO: header-portatiles__title-main y texto */}

          <div className='header-historial__icons-container'> {/* CAMBIO: header-portatiles__icons-container -> header-historial__icons-container */}
            <div className="header-historial__buttons-wrapper"> {/* CAMBIO: header-portatiles__buttons-wrapper -> header-historial__buttons-wrapper */}
