...
    // Estado para mapear subcategorías: { ID_subcategoria: 'Nombre de Subcategoría' }
...
    // Función para cargar y mapear subcategorías
    const cargarSubcategorias = async () => {
        try {
            const data = await obtenerSubcategorias();
            if (Array.isArray(data)) {
                // Crea un mapa { id_subcateg: nom_subcateg } para búsqueda rápida
                const subMap = data.reduce((acc, sub) => {
                    // La clave es el ID de la subcategoría que viene de la API de subcategorías
                    acc[sub.id_subcateg] = sub.nom_subcateg; 
                    return acc;
                }, {});
...
    // Carga inicial de subcategorías
    useEffect(() => {
        cargarSubcategorias();
    }, []);

    // Carga de solicitudes/tickets al cambiar de pestaña
    useEffect(() => {
        // Reinicia la paginación al cambiar de pestaña
        setCurrentPage(1); 
...
                        
                        // La línea crucial: Usa 'id_subcateg' para buscar el nombre en el mapa
                        const subcategoriaNombre = subcategorias[sol.id_subcateg] || 'N/A';
                        
                        return (
...
                                    > Desactivar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-lg" viewBox="0 0 16 16">
