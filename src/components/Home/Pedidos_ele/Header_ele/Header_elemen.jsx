...
  return (
    <div className='header-elementos__container'> 
      <Navbar expand="xxxl" className="w-100">
        <div className='header-elementos__content'>
...
            </Offcanvas.Body>
          </Offcanvas>
          <h1 className='header-elementos__title-main'>Solicitud elementos</h1>
          <div className='header-elementos__icons-container'>
            <div className="header-elementos__buttons-wrapper">
