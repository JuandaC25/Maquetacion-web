...
import { Navbar, Button, Offcanvas, Nav, Modal, Form } from 'react-bootstrap';
...
function Header_ad() {
    ...
    return (
        <div className='header-portatiles__container'> 
            <Navbar expand="xxxl" className="w-100">
                <div className='header-portatiles__content'>
                    ...
                    <h1 className='header-portatiles__title-main'>Solicitud portátiles</h1>
                    <div className='header-portatiles__icons-container'> 
                        <div className="header-portatiles__buttons-wrapper">
