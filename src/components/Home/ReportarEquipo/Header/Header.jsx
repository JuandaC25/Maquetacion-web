...
function Headerespacios() {
    ...
    return (
        <div className='header-informacion_equipos__container'>
            <Navbar expand="xxxl" className="w-100">
                <div className='header-informacion_equipos__content'>
                    ...
                    <h1 className='header-informacion_equipos__title-main'>Información de Equipos</h1>
                        ...
                        <div className="profile-modal__content">
                            ...
                            <div className="profile-modal__content-footer">
                                <div className="profile-modal__footer-item">
                                    ...
                                    {/* MODIFICADO: Ahora abre el Modal de Edición */}
